 ...
 */
public class SpheresLightsAndShadowsExample
implements Example
{
	@Override
	public RenderEngine createEngine()
	{
...
//		light2.setAttenuation( 0.0f, 0.0f, 1.0f ); (the default)
	...
	@Override
	public void configureView( final View3D view )
	{
//		_view.setCameraControl( new FromToCameraControl( 4.0, -8.0, 6.0 ) );
	...
	@Override
	public boolean animate( final Scene scene, final View3D view )
	{
