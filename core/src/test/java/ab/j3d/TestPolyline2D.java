...
/**
 * Test functionality of {@code Polyline2D} class.
 *
...
extends TestCase
{
	 ...
	 */
	public void testHorizontalLineConstructor()
	{
	 ...
	 */
	public void testVerticalLineConstructor()
	{
	...
	/**
	 * Test getIntersection for two rectangular poly lines. In this test, no
	 * intersection should be found.
	 */
	...
	/**
	 * Test getIntersection for two rectangular poly lines. In this test, an
	 * intersection should be found.
	 */
	...
	/**
	 * Test getIntersection for two rectangular poly lines. In this test, two
	 ...
	 * one of the value, the text is performed against the difference between X
	...
	public void testGetIntersection5()
	{
		...
		System.out.println( " - Inside, line overlap, inside." );
		{
			...
			catch ( final RuntimeException e )
			{
				...
				if ( ( message == null ) || !message.startsWith( "Path may only intersect convex poly once." ) )
				{
					throw e;
				}
			}
