	...
	extends EventObject
{
	...
	/**
	 * Location of pointer (WCS).
	 *
	 * @see     #_pointerDirection
	 */
	private Vector3D _pointerLocation;

	/**
	 * Direction of ray shot from the pointer on the view plane into the view
	 * volume (WCS).
	 * <p />
	 * This ray starts on the view plane at {@link _pointerLocation} and points
	 * into the view volume. The direction typically depends on the view
	 * transform and projection.
	 *
	 * @see     #_pointerLocation
	 * @see     ab.j3d.view.Projector#imageToView
	 */
	 ...
	 * @param   pointerLocation     Location of pointer on view plane (WCS).
	 * @param   pointerDirection    Direction of ray shot from the pointer
	 *                              on the view plane into the view volume (WCS).
	 *
	 * @throws  NullPointerException if <code>event</code> is <code>null</code>.
	 */
	public ControlInputEvent( final ControlInput controlInput , final InputEvent inputEvent , final int sequenceNumber , final boolean wasDragged , final int dragStartX , final int dragStartY , final Vector3D pointerLocation , final Vector3D pointerDirection )
	{
		super( controlInput );
	...
	public List getIntersections()
	{
		...
		{
			intersections = _controlInput.getIntersections( _pointerLocation , _pointerDirection );
	 ...
	 */
	public Vector3D getIntersectionWithPlane( final double planeNormalX , final double planeNormalY , final double planeNormalZ , final double planeDistance , final boolean twoSidedPlane )
	{
		return GeometryTools.getIntersectionBetweenRayAndPlane( planeNormalX , planeNormalY , planeNormalZ , planeDistance , twoSidedPlane , _pointerLocation , _pointerDirection );
	}
