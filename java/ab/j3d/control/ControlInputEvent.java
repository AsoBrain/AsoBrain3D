	...
	extends EventObject
{
	...
	/**
	 * Whether the mouse has been dragged since the button was pressed.
	 */
	private final boolean _wasDragged;

	/**
	 * X coordinate of pointer when drag operation was started.
	 */
	private final int _dragStartX;

	/**
	 * X coordinate of pointer when drag operation was started.
	 */
	private final int _dragStartY;
	 ...
	 *
	 * @param   controlInput    The control input on which this event occurred.
	 * @param   inputEvent      The original {@link InputEvent}.
	 * @param   sequenceNumber  The sequence number of this event.
	 * @param   wasDragged      Whether or not the mouse has been dragged
	 ...
	 * the mouse pointer in the 3D world.
	 *
