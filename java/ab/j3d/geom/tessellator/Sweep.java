    ...
    static void CallCombine(GLUtessellatorImpl tess, GLUvertex isect,
        ...
        if (isect.data == null) {
            if (!needed) {
                 ...
                 */
                tess.callErrorOrErrorData(GLUtessellator.GLU_TESS_NEED_COMBINE_CALLBACK);
 ...
 */
    private static final double SENTINEL_COORD = (4.0 * GLUtessellator.GLU_TESS_MAX_COORD);
