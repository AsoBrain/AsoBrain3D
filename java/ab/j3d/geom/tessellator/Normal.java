 ...
 */
    ...
    static void ComputeNormal(GLUtessellatorImpl tess, double[] norm) {
        ab.j3d.geom.tessellator.GLUvertex v, v1, v2;
        double c, tLen2, maxLen2;
        double[] maxVal, minVal, d1, d2, tNorm;
        ab.j3d.geom.tessellator.GLUvertex[] maxVert, minVert;
        ab.j3d.geom.tessellator.GLUvertex vHead = tess.mesh.vHead;
        int i;

        maxVal = new double[3];
        minVal = new double[3];
        minVert = new ab.j3d.geom.tessellator.GLUvertex[3];
        maxVert = new ab.j3d.geom.tessellator.GLUvertex[3];
        d1 = new double[3];
        d2 = new double[3];
        tNorm = new double[3];

        maxVal[0] = maxVal[1] = maxVal[2] = -2 * GLUtessellator.GLU_TESS_MAX_COORD;
        minVal[0] = minVal[1] = minVal[2] = 2 * GLUtessellator.GLU_TESS_MAX_COORD;
...
/* All points lie on a single line -- any decent normal will do */
    ...
    static void CheckOrientation(GLUtessellatorImpl tess) {
        double area;
        ab.j3d.geom.tessellator.GLUface f, fHead = tess.mesh.fHead;
        ab.j3d.geom.tessellator.GLUvertex v, vHead = tess.mesh.vHead;
