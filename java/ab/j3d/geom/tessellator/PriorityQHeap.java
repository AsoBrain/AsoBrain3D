...
class PriorityQHeap extends ab.j3d.geom.tessellator.PriorityQ {
    ab.j3d.geom.tessellator.PriorityQ.PQnode[] nodes;
    ab.j3d.geom.tessellator.PriorityQ.PQhandleElem[] handles;
    int size, max;
    int freeList;
    boolean initialized;
    ab.j3d.geom.tessellator.PriorityQ.Leq leq;

/* really __gl_pqHeapNewPriorityQ */
    public PriorityQHeap(ab.j3d.geom.tessellator.PriorityQ.Leq leq) {
        size = 0;
        max = ab.j3d.geom.tessellator.PriorityQ.INIT_SIZE;
        nodes = new ab.j3d.geom.tessellator.PriorityQ.PQnode[ab.j3d.geom.tessellator.PriorityQ.INIT_SIZE + 1];
        for (int i = 0; i < nodes.length; i++) {
            nodes[i] = new PQnode();
        }
        handles = new ab.j3d.geom.tessellator.PriorityQ.PQhandleElem[ab.j3d.geom.tessellator.PriorityQ.INIT_SIZE + 1];
...
/* really __gl_pqHeapDeletePriorityQ */
    ...
    void FloatDown(int curr) {
        ab.j3d.geom.tessellator.PriorityQ.PQnode[] n = nodes;
        ab.j3d.geom.tessellator.PriorityQ.PQhandleElem[] h = handles;
        int hCurr, hChild;
        int child;
...
/* returns LONG_MAX iff out of memory */
    int pqInsert(Object keyNew) {
        ...
        curr = ++size;
        if ((curr * 2) > max) {
            ab.j3d.geom.tessellator.PriorityQ.PQnode[] saveNodes = nodes;
            ab.j3d.geom.tessellator.PriorityQ.PQhandleElem[] saveHandles = handles;
