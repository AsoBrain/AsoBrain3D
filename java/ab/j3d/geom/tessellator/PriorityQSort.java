...
class PriorityQSort extends ab.j3d.geom.tessellator.PriorityQ {
    ab.j3d.geom.tessellator.PriorityQHeap heap;
    Object[] keys;
    ...
    public PriorityQSort(ab.j3d.geom.tessellator.PriorityQ.Leq leq) {
        heap = new ab.j3d.geom.tessellator.PriorityQHeap(leq);

        keys = new Object[ab.j3d.geom.tessellator.PriorityQ.INIT_SIZE];
...
/* really __gl_pqSortDeletePriorityQ */
    ...
    private static boolean LT(ab.j3d.geom.tessellator.PriorityQ.Leq leq, Object x, Object y) {
        return (!ab.j3d.geom.tessellator.PriorityQHeap.LEQ(leq, y, x));
    }

    private static boolean GT(ab.j3d.geom.tessellator.PriorityQ.Leq leq, Object x, Object y) {
        return (!ab.j3d.geom.tessellator.PriorityQHeap.LEQ(leq, x, y));
    }
...
/* really __gl_pqSortMinimum */
    Object pqMinimum() {
        ...
        if (!heap.pqIsEmpty()) {
            heapMin = heap.pqMinimum();
            if (ab.j3d.geom.tessellator.PriorityQHeap.LEQ(leq, heapMin, sortMin)) {
                return heapMin;
            }
        }
        return sortMin;
