...
public class ContentNode
{
	...
	public ContentNode( @NotNull final Object id, @Nullable final Matrix3D transform, @NotNull final Node3D node3D )
	{
		_id = id;
		_node3D = node3D;
		_transform = ( transform != null ) ? transform : Matrix3D.IDENTITY;
	}
	...
	public String toString()
	{
		return super.toString() + "[id=" + _id +
		       ", transform=" + _transform.toShortFriendlyString() +
		       ", alternate=" + _alternate +
		       ", node3D=" + _node3D +
		       ", contextActions=" + _contextActions +
		       ", cachedContent=" + _cachedContent +
		       ", cachedBounds3d=" + ( _cachedBounds3d != null ? _cachedBounds3d.toFriendlyString() : "null" ) +
		       ", subPlaneControls=" + _subPlaneControls +
		       ", planeControl=" + _planeControl +
		       ", contentNodeUpdateListeners=" + _contentNodeUpdateListeners +
		       ", control=" + _control +
		       ", castingShadows=" + _castingShadows +
		       ']';
	}
