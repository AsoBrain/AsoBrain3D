...
/**
 * A dynamic double array. Note that this class is meant for efficiency so it
...
public class DoubleArray
{
	 ...
	 */
	public DoubleArray( final double[] data, final int size )
	{
		if ( data == null )
		{
	 ...
	 */
	public DoubleArray( final int initialCapacity )
	{
	 ...
	 */
	public void ensureSize( final int minimumSize, final double initValue )
	{
		if ( minimumSize > size() )
		{
	 ...
	 */
	public void fill( final int fromIndex, final int toIndex, final double value )
	{
	 ...
	 */
	public void insert( final int index, final double element )
	{
	 ...
	 * @param   array   Array to copy elements from.
	 */
	public void insert( final int index, final double[] array )
	{
	 ...
	 */
	public void insert( final int index, final double[] array, final int offset, final int length )
	{
		final int oldSize = _size;
		if ( index > oldSize )
		{
	 ...
	 * @param   array   Array to copy elements from.
	 */
	public void insert( final int index, final DoubleArray array )
	{
	 ...
	 * @param   length  Number of elements to insert.
	 */
	public void insert( final int index, final DoubleArray array, final int offset, final int length )
	{
	...
	public double set( final int index, final double element )
	{
		...
		final double oldValue = _data[ index ];
		_data[ index ] = element;
		return oldValue;
	}
	 ...
	 * @param   size    Number of elements in the array.
	 */
	public void setData( final double[] data, final int size )
	{
		if ( data == null )
		{
			throw new IllegalArgumentException( "data = null" );
	 ...
	 * @param   initValue   Value to use for any added elements.
	 */
	public void setSize( final int size, final double initValue )
	{
		final int oldSize = _size;
		if ( size > oldSize )
		{
