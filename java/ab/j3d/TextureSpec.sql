...
CREATE TABLE TextureSpecs (
  ...
  textureScale decimal(8,3),
  ambientReflectivity decimal(8,6),
  diffuseReflectivity decimal(8,6),
  specularReflectivity decimal(8,6),
  specularExponent int(10) unsigned,
