	...
	extends JPopupMenu
{
	 ...
	 */
	ContentNodeContextMenu( final String label , final ControlInputEvent controlInputEvent , final ContentNode contentNode, final Face3DIntersection face3DIntersection )
	{
		super( label );
