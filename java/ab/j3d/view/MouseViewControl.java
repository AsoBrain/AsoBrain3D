...
//		target.addMouseWheelListener( this );
	...
	public void addMouseViewListener( final MouseViewListener listener )
	{
		if ( !_listeners.contains( listener ) )
			_listeners.add( listener );
	}

	public void removeMouseViewListener( final MouseViewListener listener )
	{
	...
	protected void fireEvent()
	{
		...
		{
			final MouseViewEvent event = new MouseViewEvent( this );
			for ( int i = 0 ; i < _listeners.size() ; i++ )
			{
				final MouseViewListener listener = (MouseViewListener)_listeners.get( i );
				listener.mouseViewChanged( event );
			}
		}
	}
