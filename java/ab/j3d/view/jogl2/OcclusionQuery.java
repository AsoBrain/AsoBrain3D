...
public class OcclusionQuery
{
	...
	public OcclusionQuery()
	{
		...
		gl2.glBeginQuery( GL2.GL_SAMPLES_PASSED , object[ 0 ] );
	}
	 ...
	 *
	 * @return  Number of rendered samples.
	 */
	public int getSampleCount()
	{
		...
		gl2.glEndQuery( GL2.GL_SAMPLES_PASSED );

		final int[] sampleCount = new int[ 1 ];
		gl2.glGetQueryObjectiv( _object , GL2.GL_QUERY_RESULT , sampleCount , 0 );
