	...
	extends Graphics2D
{
	...
	private void glBegin2D()
	{
		...
		{
			gl2.glLineWidth( ((BasicStroke)stroke).getLineWidth() );
		}
	}
	 ...
	 */
	private void drawFillImpl( final GL2 gl , final Shape shape )
	{
	...
	public void drawPolyline( final int[] xPoints , final int[] yPoints , final int nPoints )
	{
		...
		for( int i = 0 ; i < nPoints - 1 ; i++ )
		{
			...
			gl2.glVertex2i( xPoints[ i + 1 ] , yPoints[ i + 1 ] );
		}
