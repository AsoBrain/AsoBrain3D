	...
	implements Shader
{
	...
	protected CoreShader( final Type shaderType )
	{
		...
		{
			default:
			case VERTEX:   shader = gl2.glCreateShader( GL2.GL_VERTEX_SHADER );   break;
			case FRAGMENT: shader = gl2.glCreateShader( GL2.GL_FRAGMENT_SHADER ); break;
		}
		_shader = shader;
	}
	...
	private void compile()
	{
		...
		if ( compileStatus[ 0 ] == GL.GL_FALSE )
		{
			...
			gl2.glGetShaderiv( shader , GL2.GL_INFO_LOG_LENGTH , infoLogLength , 0 );
