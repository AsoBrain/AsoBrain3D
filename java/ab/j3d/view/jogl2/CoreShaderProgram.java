	...
	implements ShaderProgram
{
	...
	public void link()
	{
		if ( !_linked )
		{
			...
			gl2.glGetProgramiv( program , GL2.GL_LINK_STATUS , linkStatus , 0 );
	...
	public void validate()
	{
		...
		gl2.glGetProgramiv( program , GL2.GL_VALIDATE_STATUS , validateStatus , 0 );
	...
	public String getInfoLog()
	{
		...
		gl2.glGetProgramiv( _program, GL2.GL_INFO_LOG_LENGTH , infoLogLength , 0 );
	...
	public void enable()
	{
		...
		final GL2 gl2 = gl.getGL2();
		link();
		gl.glEnable( GL2.GL_VERTEX_PROGRAM_TWO_SIDE );
	...
	public void setUniform( final String identifier , final Vector3D value )
	{
		...
		if ( variable != -1 )
		{
			gl2.glUniform3f( variable , (float)value.x , (float)value.y , (float)value.z );
		}
	}
}
