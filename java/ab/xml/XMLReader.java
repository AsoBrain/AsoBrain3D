...
public interface XMLReader
{
	 ...
	 * if <code>next()</code> has not been called yet.
	 *
	 ...
	 * the element has no prefix) or <code>null</code> (if the element has no
	 * prefix and no default namespace is defined).
	 *
	 * @return  Namespace URI, or <code>null</code> if not defined.
	 *
	 * @throws  IllegalStateException if the current event is not
	 *          {@link XMLEventType#START_ELEMENT} or
	 *          {@link XMLEventType#END_ELEMENT}.
	 */
	@Nullable
	 ...
	 * any <code>xmlns</code> or <code>xmlns:prefix</code> attributes.
	 *
	 * @return  Number of attributes.
	 *
	 * @throws  IllegalStateException if the current event is not
	 *          {@link XMLEventType#START_ELEMENT}.
	 */
	int getAttributeCount();

	/**
	 * Returns the namespace URI of the specified attribute. If the attribute
	 * has no prefix, this method will return <code>null</code>.
	 *
	 * @param   index   Attribute index.
	 *
	 * @return  Namespace URI, or <code>null</code> if not specified.
	 *
	 * @throws  IllegalStateException if the current event is not
	 *          {@link XMLEventType#START_ELEMENT}.
	 * @throws  IndexOutOfBoundsException if the current event is a
	 *          {@link XMLEventType#START_ELEMENT} and <code>index < 0</code> or
	 *          <code>index &gt;= getAttributeCount()</code>.
	 */
	@Nullable
	 ...
	 * Returns the value of the specified attribute.
	 *
	 * @param   namespaceURI    Namespace URI, or <code>null</code> for an
	 *                          attribute with no prefix.
	 * @param   localName       Local name.
	 *
	 * @return  Attribute value; <code>null</code> if not found.
	 *
	 * @throws  IllegalStateException if the current event is not
	 *          {@link XMLEventType#START_ELEMENT}.
	 */
	 ...
	 *
	 * @throws  IllegalStateException if the current event is not
	 *          {@link XMLEventType#PROCESSING_INSTRUCTION}.
	 */
	@NotNull
	String getPITarget();
